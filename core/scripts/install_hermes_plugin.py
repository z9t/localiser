#!/usr/bin/env python3
"""Install the Regionaliser Hermes plugin into a Hermes plugins directory."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Install/copy the Regionaliser Hermes plugin.")
    ...
    (target / "regionaliser_root.txt").write_text(str(ROOT) + "\n", encoding="utf-8")
    print(target)
