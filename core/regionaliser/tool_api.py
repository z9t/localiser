"""Shared JSON-friendly tool handlers for Regionaliser integrations.
...
def _engine(db_path: str | None = None) -> Regionaliser:
    return Regionaliser(Path(db_path) if db_path else DEFAULT_DB)
