#!/usr/bin/env python3
"""CLI for deterministic local Localiser transforms, detection, and lexicon learning."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--db", default=str(DEFAULT_DB), help="SQLite DB path. Default: core/data/localiser.sqlite")
    ...
    stanza_group.add_argument("--no-stanza", dest="use_stanza", action="store_false", help="Disable optional Stanza protection even if LOCALISER_USE_STANZA is set.")
    return p
